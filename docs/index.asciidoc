...
Warning: Each mutate must be in its own code block if the sequence of operations needs to be preserved, as the order within one mutate isn't guaranteed. See bug https://github.com/logstash-plugins/logstash-filter-mutate/issues/27
